            ...
            <div class="max-w-7xl mx-auto flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button 
                        ...
                        class="p-2 sm:px-4 sm:py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white transition-all duration-300 flex items-center gap-2 text-sm font-bold shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40">
