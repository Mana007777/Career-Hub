        ...
        <div class="grid gap-5 md:grid-cols-2 xl:grid-cols-3">
            @forelse ($posts as $index => $post)
                ...
                >
                    ...
                    <!-- Post Stats (use withCount: stars_count, comments_count; stars relation may be filtered to current user only) -->
                    @php
                        $hasStarredPost = auth()->check() && $post->relationLoaded('stars') && $post->stars->isNotEmpty();
                    ...
                    <div class="flex items-center gap-6 pt-4 border-t dark:border-gray-800 border-gray-200 relative z-10">
                        <button
                            ...
                            <span>{{ $post->stars_count ?? $post->stars->count() }}</span>
                        </button>
                        <button
                            type="button"
