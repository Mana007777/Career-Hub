        ...
        return $table
            ->columns([
                ...
                Tables\Columns\IconColumn::make('suspension')
                    ->label('Suspended')
                    ->boolean()
                    ->getStateUsing(fn (User $record) => $record->isUnderActiveSuspension())
                    ->color(fn (User $record) => $record->isUnderActiveSuspension() ? 'danger' : 'success')
                    ->toggleable(),
            ...
            ->actions([
                ...
                Tables\Actions\ActionGroup::make([
                    ...
                    Tables\Actions\Action::make('unsuspend')
                        ...
                        ->color('success')
                        ->visible(fn (User $record) => $record->isUnderActiveSuspension())
                        ->requiresConfirmation()
